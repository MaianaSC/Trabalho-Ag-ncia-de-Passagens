 ...
 * @author Maiana
 */
public class ConfirmaçãoMatricula extends javax.swing.JFrame {

    
    public ConfirmaçãoMatricula() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Decolar");

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Confirmação");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Login Funcionário"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(matricula, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void acessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acessarActionPerformed
         if(matricula.getText().equals("Maiana") && jPassword.getText().equals("1234")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmaçãoMatricula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
