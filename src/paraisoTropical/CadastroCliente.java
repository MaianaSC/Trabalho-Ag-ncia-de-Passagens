...
import paraisoTropical.Passageiro;
...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        assentosdisp = new javax.swing.JLabel();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(rg))
                    .addComponent(jTextNome, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(41, 41, 41)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(assentosdisp, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(46, 46, 46))))
        );
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(endereco, javax.swing.GroupLayout.PREFERRED_SIZE, 651, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
       Passageiro clientes = new Passageiro();
        
        salvar();
        clientes.setNome(jTextNome.getText());
        clientes.setCpf(cpf.getText());
        clientes.setRg(rg.getText());
        clientes.setDataNascimento(dataNascimento.getText());
        clientes.setEndereco(endereco.getText());
        clientes.setTelefone(telefone.getText());
        clientes.setEmail(email.getText());
        
         JOptionPane.showMessageDialog(null, clientes.salvar());
         
         //Para limpar os campos apÃ³s o cadastro:
         
         jTextNome.setText(" ");
         cpf.setValue(" "); // Para limpar os campos formatados
         rg.setText(" ");
         dataNascimento.setValue(" ");  // Para limpar os campos formatados
         endereco.setText(" ");
         telefone.setValue(" ");  // Para limpar os campos formatados
         email.setText(" ");
    ...
    private javax.swing.JLabel assentosdisp;
...
public String salvar(){
          try{
            ...
            pw.println("Nome: " + this.jTextNome);
